...
| 取り込んだ旅を**送り返す** | **無料**(旅の終了+60日まで) | 止めると A→B→A の往復が切れる |
| 自分の旅を**はじめて共有する** | **Pro** | 唯一の課金点 |
| 一度共有した旅を**再送する** | **無料**(解約後も・旅の終了+60日まで) | 旅行中に期限切れで送れなくなるのを防ぐ |

**無期限にしない。** 無期限だと**一円も払わずに使い放題にできた** ── 誰かから
1つ受け取れば送り放題になるので、名前と日付と予定を入れ替えて「共有用の器」として
永久に使い回せる。サーバーもアカウントも持たない以上、「別の旅に作り変えたか」は
見分けられない。

期限は**送れるようになった瞬間に確定して凍結する**(`shareWindowUntil`):

```
min( max(旅の終了日 + 60日, いま + 90日),  いま + 3年 )
```

- **終了日が基準。** 「受け取ってから1年」だと器を来年の旅に作り変えられた
- **凍結するので、あとから日付を編集しても伸びない。** だから
  **日付の入力を制限する必要がない**(1泊延ばす・宿が取れず1週間ずらすは日常)
- **下限90日**: これが無いと、去年の旅を記録として共有した瞬間に期限切れになる。
  Pro を買った直後に「送れません」と出るのは事故にしか見えない
- **上限3年**: これが無いと、2099年の旅として共有してから解約すれば
  70年ぶん無料で送れる
- **Pro のあいだは期限を見ない**(`canShare` の1行目で抜ける)

⚠️ **編集は止めない。** 規約に「解約後も編集できます」と公開済みで、
無料の個人利用者が自分の過去の旅を編集できなくなる。止めるのは**送信だけ**。
